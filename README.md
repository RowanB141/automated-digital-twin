> **Note:** This repository contains my individual contribution (the ArcPy and Blender data pipeline) for a UT Austin Cockrell School of Engineering senior design capstone project focused on telecommunications digital twin simulations. To see the full, integrated application alongside my teammates' work for our senior showcase, please visit the [Main Project Repository](https://github.com/jessmed749/Facade-Pipeline).


# Sample Output (UT Austin)

| UT Austin Digital Twin | Google Earth Comparison |
| :---: | :---: |
| ![UT Austin Digital Twin Sample Output](images/ut_austin_digital_twin_sample_output.png) | ![Google Earth Comparison](images/google_earth_comparison.png) |
